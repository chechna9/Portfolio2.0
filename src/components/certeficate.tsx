...
const Certeficate: React.FC<certeficateProps> = ({ certeficate }) => {
  ...
  return (
    <div className="rounded-[15%] bg-prim2 m-4  transition-all duration-300  select-none  w-[25vw] h-[15vw]">
      <Popup
        ref={ref}
        trigger={
          <img
            ...
            alt=""
            className="rounded-[15%] -translate-x-3 -translate-y-3 hover:blur-sm hover:cursor-pointer transition-all duration-300  w-full h-full object-cover"
          />
        }
        modal={true}
      >
